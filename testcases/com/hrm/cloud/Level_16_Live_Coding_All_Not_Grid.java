...
public class Level_16_Live_Coding_All_Not_Grid extends BaseTest {
	...
	@BeforeClass
	public void beforeClass(String browserName, String envName, String severName, String osName, String osVersion) {

		log.info("pre-condition - Step 01: open browser  " + browserName);
		driver = getBrowserDriver(browserName, envName, severName, osName, osVersion);
